...
attribute @s minecraft:generic.max_health base set 480
attribute @s minecraft:generic.attack_damage base set 52
attribute @s minecraft:generic.movement_speed base set 0.65
