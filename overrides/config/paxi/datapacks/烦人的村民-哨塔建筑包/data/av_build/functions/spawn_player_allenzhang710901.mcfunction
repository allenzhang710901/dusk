...
scoreboard players set @e[type=buxin:angry_steve,tag=allen_ai,sort=nearest,limit=1] allen_summon_cd 40
tag @e[type=buxin:angry_steve,tag=allen_ai,sort=nearest,limit=1] add allen_ally
team join allen_allies @e[type=buxin:angry_steve,tag=allen_ai,sort=nearest,limit=1]
